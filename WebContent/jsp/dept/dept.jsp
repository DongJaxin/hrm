	 		   ...
	 		   if(checkedBoxs.length < 1){
	 			   ...
	 			   $.ligerDialog.confirm("确认要删除吗?","删除部门",function(r){
	 				   if(r){
	 					    alert("删除："+ids.get());
	 					   // 发送请求
	 					   $.post("${pageContext.request.contextPath}/dept/removeDept.do?ids="+ids.get(),
							function(data){
	            			if(data =="OK"){
	                		alert("部门删除成功！");
	...
	<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
	  ...
	  <tr valign="top">
	    <td height="30">
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr>
			  <td class="fftd">
			  	<form name="deptform" method="post" id="deptform" action="${pageContext.request.contextPath }/dept/selectDept.do">
				    <table width="100%" border="0" cellpadding="0" cellspacing="0">
					  <tr>
					    <td class="font3">
	  ...
	  <tr valign="top"><td align="center" class="font3">
	  	 <yyf:pager  pageIndex="${requestScope.pageModel.pageIndex}" 
	  	        ...
	  	        style="digg"
	  	        submitUrl="${pageContext.request.contextPath}/dept/selectDept.do?pageIndex={0}&name=${name}"/>
	  	<%--  <fkjava:pager
