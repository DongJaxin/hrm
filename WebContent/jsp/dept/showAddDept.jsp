...
<html>
	...
	<script type="text/javascript">
		...
		$("#deptForm").serialize(),function(data){
		        if(data =="OK"){
		            alert("部门添加成功！");
		            window.location.href="${pageContext.request.contextPath}/dept/selectDept.do";
		        }else{
		            alert("部门添加失败！");
    ...
    <td>
    	 <form action="" id="deptForm" method="post">
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
			...
			<tr><td align="left" class="fftd"><input type="button" value="添加 " onclick="createDept()">&nbsp;&nbsp;<input type="reset" value="取消 " onclick="javascript:history.back(-1);"></td></tr>
		  </table>
		 </form>
	</td>
  </tr>
