...
<html>
	...
	$("#deptForm").serialize(),function(data){
	        if(data =="OK"){
	            alert("部门修改成功！");
	            window.location.href="${pageContext.request.contextPath}/dept/selectDept.do?pageIndex=${pageIndex}";
	        }else{
	            alert("部门修改失败！");
    ...
    <td>
    	 <form action="${pageContext.request.contextPath}/dept/updateDept" id="deptForm" method="post">
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
			...
			<tr><td align="left" class="fftd"><input type="button" value="修改" onclick="modifyDept()">&nbsp;&nbsp;<input type="reset" value="取消 " onclick="javascript:history.back(-1);"></td></tr>
		  </table>
		 </form>
	</td>
  </tr>
