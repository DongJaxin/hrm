...
<body>
	...
	<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
				...
				<tr id="data_${stat.index}" class="main_trbg" align="center">
					<td><input type="checkbox" id="box_${stat.index}" value="${employee.id}"></td>
					 <td>${employee.name }</td>
					  ...
					  <td align="center" width="40px;"><a href="${pageContext.request.contextPath}/employee/modifyEmployee.do?flag=1&id=${employee.id}">
	  ...
	  <yyf:pager pageIndex="${requestScope.pageModel.pageIndex}" 
	  	        ...
	  	        style="digg"
	  	        submitUrl="${pageContext.request.contextPath}/employee/findEmployee.do?pageIndex={0}&name=${employee.name}&job_id=${employee.job.id}&cardId=${employee.cardId}&sex=${employee.sex}&phone=${employee.phone}&dept_id=${employee.dept.id}"/>
	  	<%--  <fkjava:pager
