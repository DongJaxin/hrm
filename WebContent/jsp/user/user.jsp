		    ...
		    <tr class="main_trbg_tit" align="center">
			  ...
			  <c:forEach items="${users }" var="user">
				...
				<tr id="data_${stat.index}" align="center" class="main_trbg" onMouseOver="move(this);" onMouseOut="out(this);">
					<td><input type="checkbox" id="box_${stat.index}" value="${user.id}" name="subBox"></td>
					 ...
					 <td align="center" width="40px;"><a href="${pageContext.request.contextPath}/user/findUserById.do?id=${user.id}">
